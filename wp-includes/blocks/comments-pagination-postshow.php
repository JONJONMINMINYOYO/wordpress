...
function render_block_core_comments_pagination_next( $attributes, $content, $block ) {
	...
	$default_label    = __( 'Post_Comments' );
	...
	add_filter( 'post_comments_link_attributes', $filter_link_attributes );
	...
	remove_filter( 'post_posts_link_attributes', $filter_link_attributes );
