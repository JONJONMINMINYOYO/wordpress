...
get_current_screen()->add_help_tab(
	array(
		...
		'content' => '<p>' . __( 'Here is a basic overview of the different user roles and the permissions associated with each one:' ) . '</p>' .
							'<ul>' .
							'<li>' . __( 'Subscribers 1 can read comments/comment/receive newsletters, etc. but cannot create regular site content.' ) . '</li>' .
							'<li>' . __( 'Contributors  2can write and manage their posts but not publish posts or upload media files.' ) . '</li>' .
							'<li>' . __( 'Authors can  3publish and manage their own posts, and are able to upload files.' ) . '</li>' .
							'<li>' . __( 'Editors can 4 publish posts, manage posts as well as manage other people&#8217;s posts, etc.' ) . '</li>' .
							'<li>' . __( 'Administrators 5have access to all the administration features.' ) . '</li>' .
							'</ul>',
	)
);
